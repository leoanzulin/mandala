...
app.controller('controlador', ['$scope',
    function ($scope) {
        ...
        $scope.conjuntosDeCamposColunas = {
            'default': ['cpf', 'nome', 'sobrenome', 'email', 'telefone_fixo', 'telefone_celular', 'telefone_alternativo', 'cidade', 'estado', "habilitacoes", 'candidato_a_bolsa', 'modalidade', 'recebe_bolsa', 'data_matricula', 'status_aluno'],
            'todos': ['cpf', 'nome', 'sobrenome', 'sexo', 'email', 'data_nascimento', 'naturalidade', 'nome_mae', 'nome_pai', 'estado_civil', 'telefone_fixo', 'telefone_celular', 'telefone_alternativo', 'cep', 'endereco', 'numero', 'complemento', 'cidade', 'estado', 'cargo_atual', 'empresa', 'telefone_comercial', 'whatsapp', 'skype', 'tipo_identidade', 'identidade', 'orgao_expedidor', 'habilitacoes', 'candidato_a_bolsa', 'modalidade', 'comentarios', 'recebe_bolsa', 'observacoes', 'data_matricula', 'status_aluno']
        };
...
//            'documento_justificativa': {'label': 'Justificativa de bolsa (documento)'},
            ...
            "habilitacoes": {'label': 'Habilitações'},
