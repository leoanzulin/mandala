...
Yii::app()->clientScript->registerScript('scripts_locais', "
    ...
    mascara_celular('#Docente_telefone');
");
?>

<h1>Editar docente <?php echo "{$model->nome} {$model->sobrenome}"; ?></h1>
...
?>
    ...
    <div class="row buttons" style="margin-top: 10px">
        <label></label>
        <?php echo CHtml::submitButton('Desativar docente', [
            'class' => 'btn btn-danger btn-lg',
            'name' => 'desativar',
            'onClick' => 'js:return confirm("Tem certeza que deseja desativar este docente?");',
        ]); ?>
    </div>
