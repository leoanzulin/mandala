...
echo CHtml::link('Adicionar novo docente', ['/docente/cadastrar']);
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'viewButtonUrl' => 'Yii::app()->createUrl("docente/visualizar", array("cpf" => $data["cpf"]))',
            'updateButtonUrl' => 'Yii::app()->createUrl("docente/editar", array("cpf" => $data["cpf"]))',
        ),
    ),
