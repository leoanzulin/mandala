...
<?php if ($ehCoordenacao) { ?>
    ...
    <div class="row">
        ...
        echo $form->dropDownList(
            ...
            [
             ...
             /** gidenilson    'disabled' => $tcc->recuperarStatus() != Tcc::FASE_VERSAO_PARA_VALIDACAO_ENTREGUE, */
            ]
        );
        ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($tcc, 'final_data_entrega', ['class' => 'curto', 'disabled' => false]); ?>
    </div>
